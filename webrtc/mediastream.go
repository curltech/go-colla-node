...
把remote track的数据发回
*/
func (this *BasePeerConnection) echo(track *webrtc.TrackRemote) error {
...
func (this *BasePeerConnection) simulcast(track *webrtc.TrackRemote) error {
	for {
...
*/
func (this *BasePeerConnection) forward(track *webrtc.TrackRemote, trackId string) error {
